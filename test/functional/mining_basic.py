...
class MiningTest(BitcoinTestFramework):
    ...
    def test_blockmintxfee_parameter(self):
        ...
        for blockmintxfee_sat_kvb in (DEFAULT_BLOCK_MIN_TX_FEE, 0, 50, 100, 500, 2500, 5000, 21000, 333333, 2500000):
            ...
            if blockmintxfee_btc_kvb > 0:
                ...
                node.prioritisetransaction(tx_below_min_feerate["txid"], -1)
    ...
    def test_block_max_weight(self):
        ...
        # Lowering the -blockreservedweight by 2000 will allow for two more transactions.
        self.restart_node(0, extra_args=[f"-datacarriersize={LARGE_VSIZE}", "-blockreservedweight=2000"])
        self.verify_block_template(
            expected_tx_count=12,
            expected_weight=MAX_BLOCK_WEIGHT - 2000,
        )

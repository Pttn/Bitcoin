...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # self.test_weight_limits() # Todo: adjust for Bech32M.
        ...
        # self.test_watchonly_cannot_grind_r() # Todo: Rewrite without Legacy
    ...
    def test_change_type(self):
        ...
        assert_raises_rpc_error(-5, "Unknown or obsolete change type ''", self.nodes[2].fundrawtransaction, rawtx, change_type='')
    ...
    def test_option_feerate(self):
        ...
        for param, value in {("fee_rate", 10000000)}:
        ...
        assert_raises_rpc_error(-8, "Cannot specify both estimate_mode and fee_rate",
            node.fundrawtransaction, rawtx, estimate_mode="economical", fee_rate=10000, add_inputs=True)

        for param in ["fee_rate"]:
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        result = [self.nodes[3].fundrawtransaction(rawtx),  # uses self.min_relay_tx_fee (set by settxfee)
            ...
            self.nodes[3].fundrawtransaction(rawtx, fee_rate=200000 * self.min_relay_tx_fee),
            self.nodes[3].fundrawtransaction(rawtx, fee_rate=200000 * self.min_relay_tx_fee, subtractFeeFromOutputs=[0]),]
    ...
    def test_22670(self):
        ...
        feerate = Decimal("0.1")
        self.restart_node(0, [f"-minrelaytxfee={feerate}", "-discardfee=0", "-addresstype=bech32"]) # Set high minrelayfee, set discardfee to 0 for easier calculation

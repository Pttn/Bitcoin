...
typedef void (*btck_NotifyHeaderTip)(void* user_data, btck_SynchronizationState state, const btck_BlockTreeEntry* entry);
...
#define btck_BlockValidationResult_TIME_FUTURE ((btck_BlockValidationResult)(7))     //!< block timestamp was in the future (or our clock is bad)
...
/**
 * @brief Return the timestamp of a certain block tree entry.
 *
 * @param[in] block_tree_entry Non-null.
 * @return                     The timestamp.
 */
BITCOINKERNEL_API int64_t BITCOINKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_time(
    const btck_BlockTreeEntry* block_tree_entry) BITCOINKERNEL_ARG_NONNULL(1);
 ...
 * @return              Nonce
 */
BITCOINKERNEL_API uint8_t* BITCOINKERNEL_WARN_UNUSED_RESULT btck_block_header_get_nonce(
    const btck_BlockHeader* header) BITCOINKERNEL_ARG_NONNULL(1);

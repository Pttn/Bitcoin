...
static constexpr unsigned int DEFAULT_BLOCK_RESERVED_WEIGHT{4000};
...
static constexpr unsigned int MINIMUM_BLOCK_RESERVED_WEIGHT{1000};
/** Default for -blockmintxfee, which sets the minimum feerate for a transaction in blocks created by mining code **/
static constexpr unsigned int DEFAULT_BLOCK_MIN_TX_FEE{MIN_FEERATE};
...
static constexpr unsigned int DEFAULT_INCREMENTAL_RELAY_FEE{MIN_FEERATE};
...
static constexpr unsigned int DEFAULT_MIN_RELAY_TX_FEE{MIN_FEERATE};

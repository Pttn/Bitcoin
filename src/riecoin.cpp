...
// Copyright (c) 2025 The Riecoin Core developers
...
Options:
  -m, --multiprocess     Run multiprocess binaries riecoin-node, riecoin-gui.
  -M, --monolithic       Run monolithic binaries riecoind, riecoin-qt. (Default behavior)
  -v, --version          Show version information
  -h, --help             Show full help message

Commands:
  gui [ARGS]     Start GUI, equivalent to running 'riecoin-qt [ARGS]' or 'riecoin-gui [ARGS]'.
  node [ARGS]    Start node, equivalent to running 'riecoind [ARGS]' or 'riecoin-node [ARGS]'.
  rpc [ARGS]     Call RPC method, equivalent to running 'riecoin-cli -named [ARGS]'.
  wallet [ARGS]  Call wallet command, equivalent to running 'riecoin-wallet [ARGS]'.
  tx [ARGS]      Manipulate hex-encoded transactions, equivalent to running 'riecoin-tx [ARGS]'.
  help           Show full help message.
)";

static constexpr auto HELP_FULL = R"(
Additional less commonly used commands:
  bench [ARGS]      Run bench command, equivalent to running 'bench_riecoin [ARGS]'.
  chainstate [ARGS] Run riecoin kernel chainstate util, equivalent to running 'riecoin-chainstate [ARGS]'.
  test [ARGS]       Run unit tests, equivalent to running 'test_riecoin [ARGS]'.
  test-gui [ARGS]   Run GUI unit tests, equivalent to running 'test_riecoin-qt [ARGS]'.
)";
...
//! Execute the specified riecoind, riecoin-qt or other command line in `args`
...
//!             be a relative path to a riecoind, riecoin-qt or other executable
...
//!
//!     strace -e trace=execve -s 10000 build/bin/riecoin ...

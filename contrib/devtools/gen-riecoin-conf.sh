...
then
  ...
  echo -e "To safely generate a riecoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example riecoin.conf file in share/examples/'
...
##
## riecoin.conf configuration file.
## Generated by contrib/devtools/gen-riecoin-conf.sh.
##
...
# parse the output from riecoind --help
